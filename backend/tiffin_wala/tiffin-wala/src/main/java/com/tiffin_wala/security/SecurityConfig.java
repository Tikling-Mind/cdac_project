	...
	public SecurityFilterChain authorizeRequests(HttpSecurity httpSecurity) throws Exception{
		httpSecurity.cors() // Add cors filter
			...
			.authorizeHttpRequests()
				.antMatchers(HttpMethod.DELETE,"/vendor","/customer").hasRole("ADMIN")
				.antMatchers("/vendor/approve","/vendor/unapproved","/vendor/status/block","/vendor/customer").hasRole("ADMIN")
